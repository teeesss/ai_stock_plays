"""
GIGACPO Intelligence Engine (V2.0)
...
class IntelligenceEngine:
    ...
    def get_percentile(self, val, key, reverse=False):
        ...
        if not all_vals: return 0.5
            
        sorted_vals = sorted(all_vals)
        if len(sorted_vals) <= 1: return 1.0 # Solo winner
    ...
    def calculate_ticker_score(self, ticker_stats):
        ...
        alpha_val = (self.get_percentile(pe, 'pe26', reverse=True) * 0.20 + 
