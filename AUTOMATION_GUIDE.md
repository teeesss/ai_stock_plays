...
Register-ScheduledTask -Action $action -Trigger $trigger -TaskName "RetireFireIntelligenceRefresh" -Description "Syncs CPO data, audits financials, and exports LLM bundles."
```
