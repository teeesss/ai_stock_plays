...
from engine.sync_news import load_news_db
...
class TestSyncDeduplication(unittest.TestCase):
    ...
    def test_deduplication_logic(self):
        ...
        # 3. Assert
        self.assertEqual(len(current_db['news']['AAPL']), 2, "Should have 2 articles (1 new, 1 dupe filtered)")
        self.assertEqual(current_db['news']['AAPL'][0]['title'], "New News", "Newest should be at the top")
