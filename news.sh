#!/bin/bash
# ============================================================================
# GIGACPO News Intelligence Bootstrapper (V30.3)
...
echo "============================================================"
echo " GIGACPO NEWS INTELLIGENCE - LINUX STARTUP"
echo "============================================================"
...
SOE_LOG="/home/jonesy/news_intel.log"
"$VENV_PYTHON" -u engine/news_market_synopsis.py --tickers tickers.txt --email 2>&1 | tee -a "$SOE_LOG"

dispatch_ts=$(date "+%a %b %d %I:%M:%S %p %Z %Y")
echo "$dispatch_ts: News Synopsis Dispatched" | tee -a "$SOE_LOG"
